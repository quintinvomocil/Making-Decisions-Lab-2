...
// The reason that this works is because the integer is being created from the loop and then is connceted to the family array with the [].
...
switch(letterGrade) {
  case "A":
    console.log("The student is doing excellent work.");
    break;
  case "B":
